...
python3 decode_sae_features.py \
    --latent_shape="4,4,4" \
    --vae_checkpoint=../checkpoints/vae_big \
    --vae_embeddings=../data/vae_embeddings.npy \
    --output_dir=../data/sae_decoded_features_1.0e-03 \
    --sae_checkpoint="../checkpoints/sae_experiments_high_l1/lr=1.0e-04_l1=1.0e-02" \
